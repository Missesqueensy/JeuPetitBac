...
public class AgentGamer extends Agent {
   ...
   /* private void loadDictionary() {
        try {
            Gson gson = new Gson();
            Reader reader = new FileReader("src/resources/dictionary.json");
    ...
    private void loadDictionary() {
        try {
            Gson gson = new Gson();
            // utilise classloader pour chercher dans le classpath
            ...
            reader.close();
            System.out.println("Dictionary loaded: " + personalDictionary.keySet());
